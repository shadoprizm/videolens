...
Chrome's extension-management page was blocked by browser automation URL policy, so the existing unpacked installation was not reloaded. Reload VideoLens manually to pick up the preview. Chrome/Firefox browser binaries have matching version 0.5.0; neither store submission has been made.
