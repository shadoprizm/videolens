...
SUMMARY_GUIDANCE = "A 2–4 sentence executive summary of what happens in the video."
...
TASKS_GUIDANCE = "0–4 follow-up tasks an agent could action. Empty list is fine."
